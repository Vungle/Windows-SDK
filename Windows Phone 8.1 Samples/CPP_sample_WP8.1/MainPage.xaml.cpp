...
void CPP_sample_WP8_1::MainPage::PlayPlacement2_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	...
	embeddedControl->OnAdStart += ref new EventHandler<VungleSDK::AdEventArgs ^>(this, &CPP_sample_WP8_1::MainPage::Embedded_OnAdStart);
	embeddedControl->OnAdEnd += ref new EventHandler<VungleSDK::AdEndEventArgs ^>(this, &CPP_sample_WP8_1::MainPage::Embedded_OnAdEnd);
...
// Event Handler called before playing an ad
void CPP_sample_WP8_1::MainPage::Embedded_OnAdStart(Platform::Object^ sender, VungleSDK::AdEventArgs^ e)
{
	this->Dispatcher->RunAsync(Windows::UI::Core::CoreDispatcherPriority::Normal,
		ref new Windows::UI::Core::DispatchedHandler(
			[this, e]
...
// Event handler called when the user leaves ad and control is return to the hosting app
void CPP_sample_WP8_1::MainPage::Embedded_OnAdEnd(Platform::Object^ sender, VungleSDK::AdEndEventArgs^ e)
{
	this->Dispatcher->RunAsync(Windows::UI::Core::CoreDispatcherPriority::Normal,
		ref new Windows::UI::Core::DispatchedHandler(
			[this, e]
...
void CPP_sample_WP8_1::MainPage::AnimateHeight(double value)
{
