...
void CPP_sample_Windows8_1::MainPage::OnInitCompleted(Platform::Object ^sender, VungleSDK::ConfigEventArgs ^args)
{
...
void CPP_sample_Windows8_1::MainPage::InitSDK_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	...
	sdkInstance->OnInitCompleted += ref new EventHandler<VungleSDK::ConfigEventArgs ^>(this, &CPP_sample_Windows8_1::MainPage::OnInitCompleted);

	this->InitSDK->IsEnabled = false;
}

void CPP_sample_Windows8_1::MainPage::LoadPlacement2_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	//Load ad for placement2
	sdkInstance->LoadAd(ref new Platform::String(std::wstring(placement2.begin(), placement2.end()).c_str()));
}

void CPP_sample_Windows8_1::MainPage::LoadPlacement3_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	//Load ad for placement3
	sdkInstance->LoadAd(ref new Platform::String(std::wstring(placement3.begin(), placement3.end()).c_str()));
}

void CPP_sample_Windows8_1::MainPage::PlayPlacement1_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
...
void CPP_sample_Windows8_1::MainPage::PlayPlacement2_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	...
	embeddedControl->OnAdStart += ref new EventHandler<VungleSDK::AdEventArgs ^>(this, &CPP_sample_Windows8_1::MainPage::Embedded_OnAdStart);
	embeddedControl->OnAdEnd += ref new EventHandler<VungleSDK::AdEndEventArgs ^>(this, &CPP_sample_Windows8_1::MainPage::Embedded_OnAdEnd);
	embeddedControl->PlayAdAsync();
}

void CPP_sample_Windows8_1::MainPage::PlayPlacement3_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
...
// Event Handler called before playing an ad
void CPP_sample_Windows8_1::MainPage::Embedded_OnAdStart(Platform::Object^ sender, VungleSDK::AdEventArgs^ e)
{
	CoreApplication::MainView->Dispatcher->RunAsync(Windows::UI::Core::CoreDispatcherPriority::Normal,
		ref new Windows::UI::Core::DispatchedHandler(
			[this, e]
...
// Event handler called when the user leaves ad and control is return to the hosting app
void CPP_sample_Windows8_1::MainPage::Embedded_OnAdEnd(Platform::Object^ sender, VungleSDK::AdEndEventArgs^ e)
{
	CoreApplication::MainView->Dispatcher->RunAsync(Windows::UI::Core::CoreDispatcherPriority::Normal,
		ref new Windows::UI::Core::DispatchedHandler(
			[this, e]
...
void CPP_sample_Windows8_1::MainPage::AnimateHeight(double value)
{
