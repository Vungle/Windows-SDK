...
void CPP_sample::MainPage::OnInitCompleted(Platform::Object ^sender, VungleSDK::ConfigEventArgs ^args)
{
			...
			[this, args]
	{
		...
		this->ClosePlacement3->IsEnabled = isInitialized;
	}));
}
...
void CPP_sample::MainPage::LoadPlacement2_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	...
	dmess << std::endl << "Attempting to load placement 2" << std::endl;
...
void CPP_sample::MainPage::LoadPlacement3_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	...
	dmess << std::endl << "Attempting to load placement 3" << std::endl;
...
void CPP_sample::MainPage::PlayPlacement3_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	...
	sdkInstance->PlayAdAsync(adConfig, "REWARDE30999");
}
...
void CPP_sample::MainPage::ClosePlacement_Click(Platform::Object ^ sender, Windows::UI::Xaml::RoutedEventArgs ^ e)
{
	...
	dmess << std::endl << "Attempting to close flex view on placement 3" << std::endl;

	OutputDebugStringA(dmess.str().c_str());

	sdkInstance->CloseFlexViewAd(ref new Platform::String(std::wstring(placement3.begin(), placement3.end()).c_str()));
	sdkInstance->CloseFlexViewAd(ref new Platform::String(std::wstring(placement2.begin(), placement2.end()).c_str()));
}
